 ...
 */
@RegisterBindButton(id = "nuiEditor", description = "${engine:menu#binding-org.terasology.rendering.nui-editor}", category = "src/main/java/org/terasology/rendering/nui")
