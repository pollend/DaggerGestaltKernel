...
public class ModuleManager {
    ...
    @Inject
    public ModuleManager(AppModuleFactory factory, boolean debug) {
        try {
            ...
            engineModule = factory.createClasspathModule(engineMetadata, false, getClass());
            ...
            ModulePathScanner scanner = new ModulePathScanner(factory);
