...
public class ModuleDependencyResolutionStrategyTest {
    ...
    private VirtualModuleEnvironmentFactory virtualModuleEnvironmentFactory = new VirtualModuleEnvironmentFactory("src/test/resources/virtualModules", getClass());
